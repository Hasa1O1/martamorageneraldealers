          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {displayProducts.map((product) => {
                const card = (
                  <div
                    className="bg-white rounded-xl shadow-lg overflow-visible hover:shadow-2xl transition-all transform hover:-translate-y-2 flex flex-col h-full"
                  >
                      ...
                      {product.features && product.features.length > 0 && (
                        <div className="space-y-1 mb-3">
                          ...
                          {product.features.length > 2 && (
                            <p className="text-xs text-gray-500" style={{ fontFamily: 'Calibri, sans-serif' }}>
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setDraftProduct((prev) => ({ ...prev, image_url: e.target.value }))}
              className="w-full rounded-3xl border border-gray-300 bg-gray-50 px-4 py-3 text-sm text-gray-900 outline-none focus:border-green-500 focus:ring-2 focus:ring-green-100"
              style={{ fontFamily: 'Calibri, sans-serif' }}
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => setDraftProduct((prev) => ({ ...prev, features: e.target.value }))}
              rows={3}
              className="w-full resize-none rounded-3xl border border-gray-300 bg-gray-50 px-4 py-3 text-sm text-gray-900 outline-none focus:border-green-500 focus:ring-2 focus:ring-green-100"
              style={{ fontFamily: 'Calibri, sans-serif' }}
            />
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-3xl rounded-3xl bg-white shadow-2xl ring-1 ring-black/10 overflow-hidden max-h-[90vh] flex flex-col">
            ...
            <div className="px-6 py-5 overflow-y-auto flex-1 space-y-4">
              <div>
                <img src={detailsProduct.image_url} alt={detailsProduct.name} className="w-full h-64 object-cover rounded-lg mb-4" />
              </div>
              <div>
                <h3 className="text-sm font-semibold text-gray-700 mb-1" style={{ fontFamily: 'Calibri, sans-serif' }}>
                  Category
                </h3>
              ...
              <div>
                ...
                <p className="text-gray-600" style={{ fontFamily: 'Calibri, sans-serif', lineHeight: '1.5' }}>
                  {detailsProduct.description}
                </p>
              </div>
              {detailsProduct.features && detailsProduct.features.length > 0 && (
                <div>
                  <h3 className="text-sm font-semibold text-gray-700 mb-3" style={{ fontFamily: 'Calibri, sans-serif' }}>
                    Features
                  </h3>
                  <div className="space-y-2">
                    {detailsProduct.features.map((feature, idx) => (
                      <div key={idx} className="flex items-start gap-2">
                        ...
                        <span className="text-gray-600" style={{ fontFamily: 'Calibri, sans-serif' }}>
                          {feature}
                        </span>
                      </div>
                    ))}

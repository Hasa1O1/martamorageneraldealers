          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredItems.map((item) => {
                const card = (
                  <div
                    className="group relative overflow-visible rounded-xl shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-2"
                  >
        ...
        <div className="space-y-5">
          <div>
            ...
            <input
              ...
              onChange={(e) => setDraftItem((prev) => ({ ...prev, title: e.target.value }))}
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => setDraftItem((prev) => ({ ...prev, description: e.target.value }))}
              rows={4}
          ...
          <div>
            ...
            <input
              ...
              onChange={(e) => setDraftItem((prev) => ({ ...prev, image_url: e.target.value }))}
              className="w-full rounded-3xl border border-gray-300 bg-gray-50 px-4 py-3 text-sm text-gray-900 outline-none focus:border-green-500 focus:ring-2 focus:ring-green-100"
              style={{ fontFamily: 'Calibri, sans-serif' }}
            />
          </div>
